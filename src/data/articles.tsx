  ...
  // ─── Article V: Battle Maps & AI ──────────────────────────
  {
    ...
    content: React.createElement('div', { className: 'art-text-flow' },
      ...
      React.createElement(InlineFigure, {
        ...
        caption: 'Pre-battle screen — 60 unit cards displayed for both forces.',
        float: 'right',
        width: '55%',
      }),
      React.createElement('p', null,
      ...
      React.createElement(InlineFigure, {
        ...
        caption: 'Battle deployment — full 60-unit card panel along the bottom.',
        float: 'left',
        width: '55%',
      }),
      React.createElement(InlineFigure, {
        ...
        caption: 'Campaign map — Napoleon\'s army with 60 unit cards visible in the bottom panel.',
        float: 'right',
        width: '55%',
      }),
      React.createElement('p', null,
