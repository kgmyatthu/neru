...
export const articles: ArticleContent[] = [
  ...
  // ─── Article V: Battle Maps & AI ──────────────────────────
  {
    ...
    content: React.createElement('div', { className: 'art-text-flow' },
      ...
      React.createElement('figure', { className: 'art-fig', style: { margin: '1rem 0' } },
        React.createElement('div', { className: 'art-fig-img' },
          React.createElement('img', { src: 'images/60ui-prebattle.jpg', alt: '60-unit UI on the pre-battle screen showing both armies' }),
        ),
        React.createElement('figcaption', null, 'Pre-battle screen — 60 unit cards displayed for both forces.'),
      ),
      React.createElement('figure', { className: 'art-fig', style: { margin: '1rem 0' } },
        React.createElement('div', { className: 'art-fig-img' },
          React.createElement('img', { src: 'images/60ui-battle.jpg', alt: '60-unit UI on the battle deployment screen' }),
        ),
        React.createElement('figcaption', null, 'Battle deployment — full 60-unit card panel along the bottom.'),
      ),
      React.createElement('figure', { className: 'art-fig', style: { margin: '1rem 0' } },
        React.createElement('div', { className: 'art-fig-img' },
          React.createElement('img', { src: 'images/60ui-campaign.jpg', alt: '60-unit UI on the campaign map' }),
        ),
        React.createElement('figcaption', null, 'Campaign map — Napoleon\'s army with 60 unit cards visible in the bottom panel.'),
      ),
      React.createElement('p', null,
